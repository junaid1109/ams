      ...
      <div class="card-body" style="padding: 20px;">
        <form id="advisoryForm" method="POST" action="{{ route('admin.advisory.update', $advisory) }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <textarea name="short_description" class="form-control @error('short_description') is-invalid @enderror" rows="2" placeholder="Brief description (shown on listing page)">{{ old('short_description', $advisory->short_description) }}</textarea>
