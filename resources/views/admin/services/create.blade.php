      ...
      <div class="card-body" style="padding: 20px;">
        <form id="serviceForm" method="POST" action="{{ route('admin.services.store') }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <textarea id="description-editor" name="description" class="form-control @error('description') is-invalid @enderror" rows="6">{{ old('description') }}</textarea>
          ...
          <div class="form-group">
            ...
            <textarea id="features-editor" name="features" class="form-control @error('features') is-invalid @enderror" rows="4">{{ old('features') }}</textarea>
            @error('features')<span class="invalid-feedback">{{ $message }}</span>@enderror
          </div>

          <div class="form-group">
            <label>Pricing (HTML)</label>
            <textarea id="pricing-editor" name="pricing" class="form-control @error('pricing') is-invalid @enderror" rows="4">{{ old('pricing') }}</textarea>
