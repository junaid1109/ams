  ...
  <div class="col-md-8">
    <div class="card">
      ...
      <div class="card-body" style="padding: 20px;">
        <form method="POST" action="<?php echo e(route('admin.home-sections.update', $homeSection)); ?>" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('section_name', $homeSection->section_name)); ?>" required placeholder="e.g., hero, about, services">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            ...
            <div style="margin-bottom: 10px;">
              <img src="<?php echo e(asset('storage/' . $homeSection->image)); ?>" alt="<?php echo e($homeSection->title); ?>" style="max-width: 200px; max-height: 150px;">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\project\sanq\mike\Axis-Laravel\resources\views/admin/home-sections/edit.blade.php ENDPATH**/ ?>