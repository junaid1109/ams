...
<?php $__env->startSection('title', 'Create Home Section - Admin'); ?>
<?php $__env->startSection('page-title', 'Create Home Page Section'); ?>
  ...
  <div class="col-md-8">
    <div class="card">
      ...
      <div class="card-body" style="padding: 20px;">
        <form method="POST" action="<?php echo e(route('admin.home-sections.store')); ?>" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>

          <div class="form-group">
            <label>Section Name (Unique identifier) *</label>
            <input type="text" name="section_name" class="form-control <?php $__errorArgs = ['section_name'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('section_name')); ?>" required placeholder="e.g., hero, about, services">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('button_text')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('button_link')); ?>" placeholder="e.g., /services or https://example.com">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('display_order', 0)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            <label>
              <input type="checkbox" name="is_active" value="1" <?php if(old('is_active', true)): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\project\sanq\mike\Axis-Laravel\resources\views/admin/home-sections/create.blade.php ENDPATH**/ ?>