  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body" style="padding: 20px;">
        ...
        <a href="<?php echo e(route('admin.portfolios.create')); ?>" class="btn btn-primary">+ Add Service</a>
        <a href="<?php echo e(route('admin.advisory.create')); ?>" class="btn btn-primary">+ Add Portfolio Item</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\project\sanq\mike\Axis-Laravel\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>